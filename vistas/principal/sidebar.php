		<!--**********************************
            ...
            <contenedor>
                ...
                <li></li> /cada li es una fila en el selector de menus que puede ser titulo, puede ser una lista de opciones, 
                o puede ser una pagina individual, o un subtitulo

                el titulo se identifica con la clase class="menu-title"

                la lista de opciones se identifica porque dentro del <li> tiene un <a> con la clase class="has-arrow" y el href contiene
                un javascript:void(0); y tambien debajo del <a> tiene una lista <ul> con mas <li><a href=""></a></li>

                y la pagina individual se identifica porque dentro del <li> tiene un <a> sin clase y con un enlace en href


                <a></a> /cada a que es de lista o de pagina individual contiene la siguiente estructura:
                <a>
                    <div>
                        <svg>
                            <g>
        ...
        ***********************************-->
		<div class="deznav">
			<div class="deznav-scroll">
				...
				<div class="copyright">
					<p>Skyadmin Sales Management System © <span class="current-year">2024</span> All Rights Reserved
					</p>
					<p>Made with <span class="heart"></span> by IndianCoder</p>
				</div>
			</div>
		</div>
