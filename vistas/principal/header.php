<?php
	...
	foreach($lineas as $linea){
		...
		if(isset($matches[2])){putenv(trim($linea));}
	}
	function echoenv($echo){
		echo(getenv($echo));
	}
?>
<!DOCTYPE html>
...
<head>
	<title><?php echoenv('Titulo_Sistema'); ?></title>

	<meta charset="utf-8">
	<meta property="og:title" 				content="<?php echoenv('Titulo_Sistema'); ?>">
	<meta property="og:description" 		content="<?php echoenv('Descripcion'); ?>">
	<meta property="og:image" 				content="<?php echoenv('Main_Logo'); ?>">
	<meta name="description" 				content="<?php echoenv('Descripcion'); ?>">
	<meta name="keywords" 					content="<?php echoenv('Keywords'); ?>">
	<meta name="twitter:title" 				content="<?php echoenv('Titulo_Sistema'); ?>">
	<meta name="twitter:description" 		content="<?php echoenv('Descripcion'); ?>">
	<meta name="twitter:image" 				content="<?php echoenv('Main_Logo'); ?>">
	...
	<link href="<?php echoenv('Favicon'); ?>" 											rel="shortcut icon" type="image/png">
...
<body>
    ...
    ********************-->
	<div id="preloader">
		<div>
			<img src="<?php echoenv('Preloader'); ?>" alt="">
		</div>
	</div>
	<!--*******************
        Preloader end
		...
		<div class="nav-header">
            <a href="index.php" class="brand-logo">
				...
				<svg class="brand-title" width="91" height="19" viewBox="0 0 91 19" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<path  class="admin1" d="M10.4929 7.7836C10.4588 7.4398 10.3125 7.1728 10.054 6.9824C9.7955 6.7921 9.4446 6.6969 9.0014 6.6969C8.7003 6.6969 8.446 6.7395 8.2386 6.8248C8.0313 6.9071 7.87219 7.0222 7.76139 7.1699C7.65339 7.3177 7.5994 7.4853 7.5994 7.6728C7.5938 7.829 7.6264 7.9654 7.6974 8.0819C7.7713 8.1983 7.8722 8.2992 8 8.3844C8.1278 8.4668 8.2756 8.5393 8.4432 8.6018C8.6108 8.6614 8.78979 8.7125 8.98009 8.7552L9.76419 8.9427C10.1449 9.0279 10.4943 9.1415 10.8125 9.2836C11.1307 9.4256 11.4063 19.6003 11.6392 9.8077C11.8722 10.0151 12.0526 10.2594 12.1804 10.5407C12.3111 10.8219 12.3778 11.1444 12.3807 11.508C12.3778 12.0421 12.2415 12.5052 11.9716 12.8972C11.7045 13.2864 11.3182 13.589 10.8125 13.8049C10.3097 14.0179 9.7031 14.1245 8.9929 14.1245C8.2884 14.1245 7.6747 14.0165 7.152 13.8006C6.6321 13.5847 6.2259 13.2651 5.9332 12.8418C5.6435 12.4157 5.49149 11.8887 5.47729 11.2608H7.26279C7.28269 11.5535 7.36649 11.7978 7.51419 11.9938C7.66479 12.187 7.8651 12.3333 8.1151 12.4327C8.3679 12.5293 8.6534 12.5776 8.9716 12.5776C9.2841 12.5776 9.5554 12.5321 9.7855 12.4412C10.0185 12.3503 10.1989 12.2239 10.3267 12.062C10.4545 11.9 10.5185 11.714 10.5185 11.5037C10.5185 11.3077 10.4602 11.1429 10.3438 11.0094C10.2301 10.8759 10.0625 10.7623 9.8409 10.6685C9.6222 10.5748 9.3537 10.4895 9.0355 10.4128L8.0852 10.1742C7.3494 9.9952 6.7685 9.7154 6.3423 9.3347C5.9162 8.954 5.7045 8.4412 5.7074 7.7964C5.7045 7.2679 5.8452 6.8063 6.1293 6.4114C6.4162 6.0165 6.8097 5.7083 7.3097 5.4867C7.8097 5.2651 8.37779 5.1543 9.01419 5.1543C9.66189 5.1543 10.2273 5.2651 10.7102 5.4867C11.196 5.7083 11.5739 6.0165 11.8438 6.4114C12.1136 6.8063 12.2528 7.2637 12.2614 7.7836H10.4929ZM13.6218 14.0009V5.2736H15.467V9.1216H15.582L18.7227 5.2736H20.9343L17.6957 9.1813L20.9727 14.0009H18.7653L16.3746 10.4128L15.467 11.5208V14.0009H13.6218ZM21.3839 5.2736H23.4506L25.4407 9.0321H25.5259L27.516 5.2736H29.5827L26.3995 10.9157V14.0009H24.5671V10.9157L21.3839 5.2736Z" fill="black"/>
				</svg>
            </a>
